...
class CNN_GRU_wf_tally:
    ...
    def create_architecture(self):
        ...
        model.add(GRU(self.gru_units, name='gru_output'))
    ...
    def get_intermediate_layer_output(self, data):
        self.intermediate_layer_model = Model(
            ...
            outputs=self.model.get_layer('gru_output').output)
        return self.intermediate_layer_model.predict(data)