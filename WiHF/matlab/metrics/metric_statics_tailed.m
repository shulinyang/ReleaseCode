...
sample_length_time = zeros(total_user*total_gesture*total_position*total_orientation*10,4);
time_index=0;
            ...
            for orientation_index = 1:total_orientation
                ...
                for instance_index = 1:total_instance
                    ...
                    for instance_follower_index = instance_index+1:total_instance
                        data_file_name_follower = [data_file_prefix,num2str(user_index), '-', num2str(anchor_gesture_index), '-', num2str(position_index),...
                            '-', num2str(orientation_index), '-', num2str(instance_follower_index)];
                        try
                            % Generate Doppler Spectrum
                            time_index=time_index+1;
                            [doppler_spectrum, freq_axis_bin,velocity_axis_bin,sample_length_time(time_index,1),sample_length_time(time_index,2)] = generate_doppler_spectrum_gesture_instance_tailed([data_path, data_file_name],[data_path, data_file_name_follower],...
                            ...
                            disp(['Loading ', data_file_name,',',data_file_name_follower])
