...
tic
for user_index=5:total_user
    data_path=[data_pwd,data_type{user_index}];
    for gesture_index = 7:total_gesture
...
%                             toc
                            ...
                            %                             Save VS
%                             toc
                            save_data_file_name = [num2str(user_index), '-', num2str(gesture_index), '-', num2str(position_index),...
