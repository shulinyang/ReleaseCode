function [main_path,velocity_mapping_feature] = seam_carving_freq_tailed_path(doppler_spectrum, velocity_axis_bin, time_axis_number,path_group_size,main_path_number,path_area,kernel_type,path_type,velocity_bin,V_resolution,attenuation_efficient)
...
for path_index=1:main_path_number
    ...
    for freq_axis_index=1:freq_axis_number
        ...
        %             continue;
        %         end
        main_path(index,freq_axis_index)=1;
