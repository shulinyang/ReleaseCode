function [main_path,velocity_mapping_feature,velocity_sequence] = graph_matching_multipath_path(doppler_spectrum, velocity_axis_bin, time_axis_number,path_group_size,main_path_number,path_area,velocity_bin,V_resolution,attenuation_efficient)
...
%         velo_sequence_bins(path_index,time_axis_index)=index/ size(doppler_spectrum_grouped,1);
        ...
        main_path(index,time_axis_index)=1;
