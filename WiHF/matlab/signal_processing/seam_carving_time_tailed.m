function [main_path,velocity_mapping_feature] = seam_carving_time_tailed(doppler_spectrum, velocity_axis_bin, time_axis_number,path_group_size,main_path_number,path_area,kernel_type,path_type,velocity_bin,velocity_resolution,attenuation_efficient)
...
%             continue;
%         end
        main_path(velocity_axis_index,time_axis_index)=main_path(velocity_axis_index,time_axis_index)+doppler_spectrum_grouped(velocity_axis_index,time_axis_index);
