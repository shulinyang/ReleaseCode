...
if ~exist(save_path,'file')==0
    ...
    plot_line_h=ones(2,3,3,3,200)*0.1;
    plot_line_v=ones(2,3,5,3,30)*0.1;
end
...
for user_index=[8]
    ...
    for gesture_index = [6,8]
        gesture_fig_index=gesture_fig_index+1;
        position_fig_index=0;
        for orientation_index = 1:1
            for instance_index = [4]
                for position_index = [1,4,5]
                    position_fig_index=position_fig_index+1;
                            ...
                            for mm = 1:1
                                ...
                                if ~exist(save_path,'file')==0
                                    for line_index_h=1:size(plot_line_h,3)
                                        plot_data=squeeze(plot_line_h(gesture_fig_index,position_fig_index,line_index_h,:,:));
                                        hold on;
                                    ...
                                    for line_index_h=1:size(plot_line_h,3)
                                        ...
                                        plot_line_h(gesture_fig_index,position_fig_index,line_index_h,1,:)=sequence(1:size(plot_line_h,5));
                                        plot_line_h(gesture_fig_index,position_fig_index,line_index_h,2,:)=interp1(data(1,:),data(2,:),  plot_line_h(gesture_fig_index,position_fig_index,line_index_h,1,:));
                                    ...
                                    for line_index_v=1:size(plot_line_v,3)
                                        ...
                                        plot_line_v(gesture_fig_index,position_fig_index,line_index_v,2,:)=sequence(1:size(plot_line_v,5));
                                        plot_line_v(gesture_fig_index,position_fig_index,line_index_v,1,:)=interp1(data(1,:),data(2,:),  plot_line_v(gesture_fig_index,position_fig_index,line_index_v,1,:));
                                        hold on;
                                        plot_data=squeeze(plot_line_v(gesture_fig_index,position_fig_index,line_index_v,:,:));
                                        h(4)=plot3(plot_data(1,:),plot_data(2,:),plot_data(3,:)+0.1,':','color',color_dot(4,:),'linewidth',5);
                                        datacursormode off
